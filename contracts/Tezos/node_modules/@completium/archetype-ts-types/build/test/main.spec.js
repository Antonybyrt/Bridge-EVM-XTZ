...
describe('Micheline', () => {
    ...
    test('normalize Pair', () => {
        ...
        expect(JSON.stringify((0, main_1.normalize)(a))).toBe(JSON.stringify(b));
    });
});
describe('ArchetypeType', () => {
    describe('Address', () => {
        ...
        test('Succeeds from_mich with Valid tz1 User Address in string', () => {
            ...
            expect(main_1.Address.from_mich(input).toString()).toBe("tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb");
        });
        ...
        test('Succeeds from_mich with Valid tz2 User Address in string', () => {
            ...
            expect(main_1.Address.from_mich(input).toString()).toBe("tz28US7zJ7rLdWke75XEM3T5cLWCCxjnP4zf");
        });
        ...
        test('Succeeds from_mich with Valid tz3 User Address in string', () => {
            ...
            expect(main_1.Address.from_mich(input).toString()).toBe("tz3hFR7NZtjT2QtzgMQnWb4xMuD6yt2YzXUt");
        });
        ...
        test('Succeeds from_mich with Valid tz4 User Address in bytes', () => {
            ...
            expect(main_1.Address.from_mich(input).toString()).toBe("tz4HVR6aty9KwsQFHh81C1G7gBdhxT8kuytm");
        });
        test('Succeeds from_mich with Valid tz4 User Address in bytes', () => {
        ...
        test('Succeeds from_mich with Valid sr1 User Address in string', () => {
            ...
            expect(main_1.Address.from_mich(input).toString()).toBe("sr1RYurGZtN8KNSpkMcCt9CgWeUaNkzsAfXf");
        });
        ...
        test('Succeeds from_mich with Valid KT1 User Address in string', () => {
            ...
            expect(main_1.Address.from_mich(input).toString()).toBe("KT1AaaBSo5AE6Eo8fpEN5xhCD4w3kHStafxk");
        });
        ...
        test('Succeeds from_mich with Valid KT1 User Address 2 in string', () => {
            ...
            expect(main_1.Address.from_mich(input).toString()).toBe("KT1TBXEeXzaUYh2oySDEibrxRW8e2hv9gVXi");
        });
        ...
        test('Succeeds from_mich with Valid KT1 User Address 3 in string', () => {
            ...
            expect(main_1.Address.from_mich(input).toString()).toBe("KT1SUP27JhX24Kvr11oUdWswk7FnCW78ZyUn");
        });
    ...
    describe('Chain_id', () => {
        ...
        test('Succeeds from_mich with Valid Chain_id 1 in string', () => {
            ...
            expect(main_1.Chain_id.from_mich(input).toString()).toBe("NetXdQprcVkpaWU");
        });
        ...
        test('Succeeds from_mich with Valid Chain_id 2 in string', () => {
            ...
            expect(main_1.Chain_id.from_mich(input).toString()).toBe("NetXynUjJNZm7wi");
        });
    ...
    describe('Date', () => {
        test('Succeeds mich_to_date with Valid date in string', () => {
            ...
            const res = (0, main_1.mich_to_date)(input);
    ...
    describe('Duration', () => {
        ...
        test('Neg 365 days in second string', () => {
            expect(new main_1.Duration("-31536000").toSecond()).toBe(-31536000);
        });
    });
    describe('Entrypoint', () => {
        test('test from_mich basic', () => {
            const input = { string: "KT1PkBvorKLwdrP3UWUMo3ytZrRUq3wqfFGe" };
            expect(main_1.Entrypoint.from_mich(input).toString()).toBe("KT1PkBvorKLwdrP3UWUMo3ytZrRUq3wqfFGe%default");
        });
        test('test from_mich with annot', () => {
            const input = { string: "KT1PkBvorKLwdrP3UWUMo3ytZrRUq3wqfFGe%my_entrypoint" };
            expect(main_1.Entrypoint.from_mich(input).toString()).toBe("KT1PkBvorKLwdrP3UWUMo3ytZrRUq3wqfFGe%my_entrypoint");
        });
    });
    describe('Key', () => {
        test('Fails with empty string', () => {
        ...
        test('Succeeds from_mich with Valid edpk Key in string', () => {
            ...
            expect(main_1.Key.from_mich(input).toString()).toBe("edpkvGfYw3LyB1UcCahKQk4rF2tvbMUk8GFiTuMjL75uGXrpvKXhjn");
        });
        ...
        test('Succeeds from_mich with Valid edpk Key in string', () => {
            ...
            expect(main_1.Key.from_mich(input).toString()).toBe("sppk7b4TURq2T9rhPLFaSz6mkBCzKzfiBjctQSMorvLD5GSgCduvKuf");
        });
        ...
        test('Succeeds from_mich with Valid sppk Key in string', () => {
            ...
            expect(main_1.Key.from_mich(input).toString()).toBe("p2pk65zwHGP9MdvANKkp267F4VzoKqL8DMNpPfTHUNKbm8S9DUqqdpw");
        });
        test('Succeeds from_mich with Valid edpk Key in bytes', () => {
    ...
    describe('Rational', () => {
        ...
        describe('to_mich', () => {
            ...
            it('String with big number with denom int', () => {
                expect(JSON.stringify(new main_1.Rational(1, 2).to_mich())).toBe('{"prim":"Pair","args":[{"int":"1"},{"int":"2"}]}');
            });
    ...
    describe('Signature', () => {
        ...
        test('Succeeds from_mich with Valid sig Signature in string', () => {
            ...
            expect(main_1.Signature.from_mich(input).toString()).toBe("sigPGRuva6xjBJkmb6BYpbovGb4BoobkE3GUN2njdxwkG25yRT39GaDrsBgczf5VybSRGi5eddQy6VBfUkg2YcLfMvgg8Uk1");
        });
        ...
        test('Succeeds from_mich with Valid edsig Signature in string', () => {
            ...
            expect(main_1.Signature.from_mich(input).toString()).toBe("edsigthXYBNW7i5E1WNd87fBRJKacJjK5amJVKcyXd6fGxmnQo2ESmmdgN6qJXgbUVJDXha8xi96r9GqjsPorWWpPEwXNG3W8vG");
        });
        test('Succeeds from_mich with Valid edsig Signature in bytes', () => {
            ...
            expect(main_1.Signature.from_mich(input).toString()).toBe("sigXi54KHDS92yTBdpydLEM2J6XuE9c8RtwwDntkfHxRmTVCHrGsibH3bPV5ygPq3BG2fLndKVJesy8bmerNUR3tTGMZzC6J");
        });
        test('Succeeds from_mich with Valid spsig Signature in string', () => {
            ...
            expect(main_1.Signature.from_mich(input).toString()).toBe("spsig1VrEwwc2UC4v9v3oYJ96VwiKwdVKK7ZYdMs4JVWNtfj11sRz9RkvPBtCHMiG1LEp44PJBXDh7bAzpDjGoX4bH7heoPuGqa");
        });
        test('Succeeds from_mich with Valid spsig Signature in bytes', () => {
            ...
            expect(main_1.Signature.from_mich(input).toString()).toBe("sign2Zcszmzr6mmk43a9awr32x2ohkF3vr9njjXhM55moHaonAxrgYS4QLaz9AwwAwyLe9SZN4gT2Giw2AHeP6MuAYHSeT9D");
        });
        test('Succeeds from_mich with Valid p2sig Signature in string', () => {
            ...
            expect(main_1.Signature.from_mich(input).toString()).toBe("p2siguNBbkRwuMKCyG9NeQb4ETNCDyqUnUCX4T4Um4dFgzCKyA7AzS4a6XBk1Encj4ndXsbK98UYNunZ7vHHFHMhh7jdajUHTY");
        });
        test('Succeeds from_mich with Valid p2sig Signature in bytes', () => {
            ...
            expect(main_1.Signature.from_mich(input).toString()).toBe("sigv3xkfLPotPAWKtcPgzXSwuQqbBFXNn6r1HdNfApPmk3RcqPg41UsF1Ki3r6Vdb4DFZo84Ec3QqEkXbMWguWFr3HgNFr4G");
        });
        test('Succeeds with Valid sig Signature', () => {
            const input = "sigPGRuva6xjBJkmb6BYpbovGb4BoobkE3GUN2njdxwkG25yRT39GaDrsBgczf5VybSRGi5eddQy6VBfUkg2YcLfMvgg8Uk1";
            const output = "sigPGRuva6xjBJkmb6BYpbovGb4BoobkE3GUN2njdxwkG25yRT39GaDrsBgczf5VybSRGi5eddQy6VBfUkg2YcLfMvgg8Uk1";
            expect(new main_1.Signature(input).normalize()).toBe(output);
        });
        test('Succeeds with Valid edsig Signature', () => {
            const input = "edsigthXYBNW7i5E1WNd87fBRJKacJjK5amJVKcyXd6fGxmnQo2ESmmdgN6qJXgbUVJDXha8xi96r9GqjsPorWWpPEwXNG3W8vG";
    ...
    describe('Key_hash', () => {
        ...
        test('Succeeds from_mich with Valid tz1 User Address in string', () => {
            const input = { "string": "tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb" };
            expect(main_1.Key_hash.from_mich(input).toString()).toBe("tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb");
        });
        test('Succeeds from_mich with Valid tz1 User Address in bytes', () => {
            const input = { "bytes": "00006b82198cb179e8306c1bedd08f12dc863f328886" };
            expect(main_1.Key_hash.from_mich(input).toString()).toBe("tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb");
        ...
        test('Succeeds from_mich with Valid tz2 User Address in string', () => {
            const input = { "string": "tz28US7zJ7rLdWke75XEM3T5cLWCCxjnP4zf" };
            expect(main_1.Key_hash.from_mich(input).toString()).toBe("tz28US7zJ7rLdWke75XEM3T5cLWCCxjnP4zf");
        });
        test('Succeeds from_mich with Valid tz2 User Address in bytes', () => {
            const input = { "bytes": "000101bd4f40df4b2935b9508e7a7683a6a060b64303" };
            expect(main_1.Key_hash.from_mich(input).toString()).toBe("tz28US7zJ7rLdWke75XEM3T5cLWCCxjnP4zf");
        ...
        test('Succeeds from_mich with Valid tz3 User Address in string', () => {
            const input = { "string": "tz3hFR7NZtjT2QtzgMQnWb4xMuD6yt2YzXUt" };
            expect(main_1.Key_hash.from_mich(input).toString()).toBe("tz3hFR7NZtjT2QtzgMQnWb4xMuD6yt2YzXUt");
        });
        test('Succeeds from_mich with Valid tz3 User Address in bytes', () => {
            const input = { "bytes": "0002e57a81394a9c8e5443733ed5ac14aaf5394ef541" };
            expect(main_1.Key_hash.from_mich(input).toString()).toBe("tz3hFR7NZtjT2QtzgMQnWb4xMuD6yt2YzXUt");
        ...
        test('Succeeds from_mich with Valid tz4 User Address in bytes', () => {
            const input = { "string": "tz4HVR6aty9KwsQFHh81C1G7gBdhxT8kuytm" };
            expect(main_1.Key_hash.from_mich(input).toString()).toBe("tz4HVR6aty9KwsQFHh81C1G7gBdhxT8kuytm");
        });
        test('Succeeds from_mich with Valid tz4 User Address in bytes', () => {
            const input = { "bytes": "00035d1497f39b87599983fe8f29599b679564be822d" };
            expect(main_1.Key_hash.from_mich(input).toString()).toBe("tz4HVR6aty9KwsQFHh81C1G7gBdhxT8kuytm");
        ...
        test('Succeeds from_mich with Valid sr1 User Address in string', () => {
            const input = { "string": "sr1RYurGZtN8KNSpkMcCt9CgWeUaNkzsAfXf" };
            expect(main_1.Key_hash.from_mich(input).toString()).toBe("sr1RYurGZtN8KNSpkMcCt9CgWeUaNkzsAfXf");
        });
        test('Succeeds from_mich with Valid sr1 User Address in bytes', () => {
            const input = { "bytes": "03d601f22256d2ad1faec0c64374e527c6e62f2e5a00" };
            expect(main_1.Key_hash.from_mich(input).toString()).toBe("sr1RYurGZtN8KNSpkMcCt9CgWeUaNkzsAfXf");
